    ...
    <div class="divPanel notop nobottom">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="navbar">
                        <button type="button" class="btn btn-navbar-highlight btn-large btn-secondary" data-toggle="collapse" data-target=".nav-collapse">
                        ...
                        <div class="nav-collapse collapse">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="regulacion-mercado.html">SMVP</a></li>
  ...
  <fieldset>
	...
	<input type="submit" value="Enviar" name="submit" id="submitButton" class="btn btn-secondary pull-right" title="Hás click para enviar!" />
			...
			<!--/End Sidebar Content-->
                ...
                <div class="row-fluid">
            	<div class="span12">
                        <iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps?t=m&amp;q=Edificio+Ocean+Business+Plaza+(Torre+Banesco),+Calle+47,+Panam%C3%A1,+San+Miguelito,+Panam%C3%A1,+Panama&amp;ie=UTF8&amp;hl=pt&amp;geocode=Fcr5iAAd5JNC-w&amp;split=0&amp;hq=&amp;hnear=Edificio+Ocean+Business+Plaza+(Torre+Banesco),+Calle+47,+Panam%C3%A1,+San+Miguelito,+Panam%C3%A1,+Panama&amp;ll=8.988514,-79.519558&amp;spn=0.029672,0.036478&amp;z=14&amp;iwloc=A&amp;output=embed" class="img-polaroid" style="margin:5px 0px 15px;color:#0000FF;" ></iframe><br />
                </div>
            </div>			
