...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
  ...
  <div class="form">
    <form action="<c:url value='/cliente/save'/>" method="POST">
        ...
        <input type="text" name="cliente.id" required value="${cliente.id}" hidden/>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" rows="3" name="cliente.informacoesAdicionais" value="${cliente.informacoesAdicionais}"></textarea>
        </div>
        <div class="form-group">
            <label>Perfil:</label>
            <div class="radio">
        ...
        <div class="form-group">
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="cliente.ativos[]" value="Plazos Fijos / Tasas de Interés fijas / Renta Fija" <c:if test="${cliente.ativos.contains('Plazos Fijos / Tasas de Interés fijas / Renta Fija')}"> checked</c:if>>Plazos Fijos / Tasas de Interés fijas / Renta Fija
                </label>
            </div>
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="cliente.ativos[]" value="Renta Variable como Acciones y Fondos de Inversión" <c:if test="${cliente.ativos.contains('Renta Variable como Acciones y Fondos de Inversión')}"> checked</c:if>>Renta Variable como Acciones y Fondos de Inversión
                </label>
            </div><div class="checkbox">
                <label>
                    <input type="checkbox" name="cliente.ativos[]" value="Monedas como dólares, euros, libras esterlinas, etc." <c:if test="${cliente.ativos.contains('Monedas como dólares, euros, libras esterlinas, etc.')}"> checked</c:if>>Monedas como dólares, euros, libras esterlinas, etc.
                </label>
            </div><div class="checkbox">
                <label>
                    <input type="checkbox" name="cliente.ativos[]" value="Otros Activos como derivados, notas estructuradas, ETFs, etc." <c:if test="${cliente.ativos.contains('Otros Activos como derivados, notas estructuradas, ETFs, etc.')}"> checked</c:if>>Otros Activos como derivados, notas estructuradas, ETFs, etc.
                </label>
            </div>
        </div>
        <div class="form-group">
